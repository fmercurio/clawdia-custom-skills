...
| --- | --- | --- | --- | --- |
| creative | creative-production-orchestration | approved | Provider-neutral orchestration for recurring creative production across brand systems, product visuals, thumbnails/covers, campaign assets and video briefs. Routes only to approved local capabilities and enforces consent, approval, quality and distribution gates. | [creative-production-orchestration](skills/creative/creative-production-orchestration/SKILL.md) |
...
| productivity | whatsapp-receive-only-monitor | candidate | Public, implementation-neutral workflow for a private WhatsApp monitor with an enforceable receive-only collector, exact group allowlists, a private journal, and separately scoped sanitized alerts or digests—without WhatsApp participation, direct-message monitoring, broad collection, or backfill. | [whatsapp-receive-only-monitor](skills/productivity/whatsapp-receive-only-monitor/SKILL.md) |
